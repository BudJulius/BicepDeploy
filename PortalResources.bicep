  ...
  properties: {
    ...
    parameters: {
      '$connections': {
        value: {
          office365: {
            id: '/subscriptions/${subscription().subscriptionId}/providers/Microsoft.Web/locations/${location}/managedApis/${office365Connection.properties.api.id}'
            connectionName: office365Connection.name
            connectionId: '/subscriptions/${subscription().subscriptionId}/resourceGroups/${resourceGroup().name}/providers/Microsoft.Web/connections/${office365Connection.name}'
          }
        }
      }
    }
